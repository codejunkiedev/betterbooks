    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {generatedRefNo || invoiceData.invoiceRefNo || "Generating..."}
                    </p>
                  </div>
                  <div>
                    <span className="font-medium">Total Amount:</span>
                    <p className="text-muted-foreground">
                      Rs. {calculateRunningTotalsForCalculatedItems(invoiceData.items).total_amount.toString()}
                    </p>
                  </div>
                </div>
          ...
          {(status.stage === "error" || status.stage === "timeout") && (
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                {status.stage === "error" && (
                  <div className="space-y-2">
                    <p className="text-muted-foreground">The submission failed. Common causes:</p>
                    <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
        ...
        <div className="flex justify-end gap-3 pt-6 border-t">
          ...
          {status.stage === "success" && <Button onClick={handleClose}>Done</Button>}
