...
DROP FUNCTION IF EXISTS complete_onboarding_transaction(JSONB, JSONB, JSONB, BOOLEAN, UUID);
...
BEGIN
    ...
    -- Validate province code and convert to INTEGER
    ...
    BEGIN
        ...
        -- Step 2: Copy COA template to company with template_id
        ...
        -- Step 4: Create FBR profile with correct data types
        INSERT INTO fbr_profiles (
            ...
            v_cnic_ntn,
            v_business_name,
            v_province_code,  -- Now correctly typed as INTEGER
            v_address,
            v_mobile_number,
