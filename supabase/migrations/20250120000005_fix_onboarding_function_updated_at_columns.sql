...
-- Create updated function without updated_at column references for companies and user_business_activities
...
BEGIN
    ...
    BEGIN
        ...
        IF v_business_activity_selection IS NOT NULL THEN
            ...
            LOOP
                ...
                IF v_combination_id IS NOT NULL THEN
                    -- Add to user business activities using the new structure (without updated_at)
        ...
        ELSE
            -- Legacy structure: add all business activities to user_business_activities table (without updated_at)
