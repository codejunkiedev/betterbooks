...
-- Add comment
COMMENT ON FUNCTION public.complete_onboarding_transaction IS 'Complete user onboarding process with company setup, FBR profile, and business activities - Fixed for current schema';
...
BEGIN
    ...
    IF function_count = 1 THEN
        RAISE NOTICE 'SUCCESS: complete_onboarding_transaction function recreated with correct schema';
    ELSE
