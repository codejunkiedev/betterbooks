...
-- Create company_type enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create account_type enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create activity_type enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create document_status enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create document_type enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create invoice_type enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create role enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create status enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create availability_status enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
...
-- Create registration_type enum if it doesn't exist (matching existing codebase)
DO $$ 
BEGIN
