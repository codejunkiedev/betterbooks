...
-- Create updated function with new business activity and sector structure support
...
BEGIN
    ...
    BEGIN
        ...
        IF v_business_activity_selection IS NOT NULL THEN
            ...
            LOOP
                ...
                IF v_combination_id IS NOT NULL THEN
                    -- Add to user business activities using the new structure
        ...
        ELSE
            -- Legacy structure: add all business activities to user_business_activities table
