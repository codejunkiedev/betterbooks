-- Migration: Ensure user_business_activities table exists with correct structure
-- This creates the missing table that's needed for the onboarding function
...
DO $$
BEGIN
    RAISE NOTICE 'User business activities table and related tables created successfully';
END $$;
