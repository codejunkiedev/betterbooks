...
**Required per-environment base URL (frontend):**
```env
# Set to your environment URL
# production: https://prod.usebetterbooks.com
# staging:   https://staging.usebetterbooks.com
# development: http://localhost:5173 (or your dev URL)
VITE_APP_BASE_URL=YOUR_APP_URL
```

**Supabase Edge Functions (set in Supabase project settings → Functions env variables):**
```env
# Comma-separated list of allowed origins for CORS
ALLOWED_ORIGINS=https://prod.usebetterbooks.com,https://staging.usebetterbooks.com,https://dev.usebetterbooks.com,http://localhost:5173
# Base URL used in emails and links generated by functions
APP_BASE_URL=https://prod.usebetterbooks.com
```
